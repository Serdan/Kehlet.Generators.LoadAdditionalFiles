...
### LoadAdditionalFiles.Analyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [LoadAdditionalFiles.Analyzer.Sample.csproj](../LoadAdditionalFiles.Analyzer.Sample/LoadAdditionalFiles.Analyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### LoadAdditionalFiles.Analyzer.Tests
